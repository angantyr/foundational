...
class Design::Navigation::Shared::MenuItemComponentPreview < ViewComponent::Preview
  # @label Default
  def default
    render(Design::Navigation::Shared::MenuItemComponent.new(
      label: "Corporate",
  ...
  def card_grid
    components = [
      Design::Navigation::Shared::MenuItemComponent.new(
        label: "Corporate",
        href: "/modules/corporate",
        icon: "hotel",
        description: "Manage companies, subsidiaries, offices, and people. Define reporting structures, organizational charts, departments, and teams.",
